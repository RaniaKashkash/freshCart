...
export default function ProductTabInfo({productDetails}) {
  ...
  <section className='p-5 space-y-6'>
    ...
    <div className="space-y-2">
        ...
        <p className='text-gray-600'>For optimal freshness, refrigerate strawberries unwashed in their original container or in a paper towel-lined container. Wash just before eating. To extend shelf life, remove any damaged berries as soon as possible.</p>
    </div>
    <div className="space-y-2">
